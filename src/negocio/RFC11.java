...
public class RFC11 {
	 ...
	 */
	public RFC11(long semana, long id_servicio_max, long maximo, long id_servicio_min, long minimo,
	...
	public String toString() {
		return semana + " " + id_servicio_max+ " " +maximo+ " " +id_servicio_min+ " " +minimo+ " ; " +id_habitacion_max+ " " +max_habitacion+ " " +id_habitacion_min+ " " +min_habitacion;
	}
